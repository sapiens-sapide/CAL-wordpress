    ...
    if (!defined($more_plugins)) {
        ...
        class more_plugins_object_sputnik_8
        {
            ...
            */
            ...
            function load_save_files ()
            {
                ...
                if (is_dir($dir)) {
                    ...
                    $pts = array();
                    foreach ($ls as $l) if (strpos($l, '.php')) {
                        $pts[] = $l;
                    }
            ...
            */
            ...
            {
                if (empty($this->data_loaded)) {
                    $this->data_loaded = $this->load_objects();
                }
                if (!empty($keys)) {
                    $ret = array();
                    foreach ($keys as $key) {
            ...
            function load_objects ($data = array())
            {
                ...
                if (!$data['_plugin_saved']) {
                    $data['_plugin_saved'] = array();
                }
            ...
            function elsewhere_data ($data, $wpdata)
            {
                ...
                foreach ($wpdata as $key => $item) {
                    if (in_array($key, (array)$this->settings['default_keys'])) {
                        continue;
                    }
