...
/* Bulk Dropdown menu Role changes */
        ...
        case 'dodelete':
            ...
            $redirect = add_query_arg(array('delete_count' => $delete_count,
        ...
        case 'delete':
            ...
            <form action="" method="post" name="updateusers" id="updateusers">
                ...
                <div class="wrap">
                    ...
                    <fieldset>
                        <p>
                            <legend><?php echo _n('What should be done with posts and links owned by this user?', 'What should be done with posts and links owned by these users?', $go_delete); ?></legend>
                        </p>
                        <ul style="list-style:none;">
                            <li>
                                <label><input type="radio" id="delete_option0" name="delete_option" value="delete" checked="checked"/>
