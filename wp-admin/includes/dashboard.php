<?php
    ...
    <form name="post" action="<?php echo esc_url(admin_url('post.php')); ?>" method="post" id="quick-press">
        ...
        <script type="text/javascript">edCanvas = document.getElementById('content');
    ...
    function _wp_dashboard_recent_comments_row (&$comment, $show_date = true)
    {
        ...
        if (current_user_can('edit_comment', $comment->comment_ID)) {
            ...
            $actions['spam'] = "<a href='$spam_url' class='delete:the-comment-list:comment-$comment->comment_ID::spam=1 vim-s vim-destructive' title='" . esc_attr__('Mark this comment as spam') . "'>" . /* translators: mark as spam link */
                _x('Spam', 'verb') . '</a>';
            if (!EMPTY_TRASH_DAYS)
...
<?php
    ...
    {
        wp_dashboard_rss_control('dashboard_incoming_links', array('title'        => false,
                                                                   'show_summary' => false,
                                                                   'show_author'  => false));
    }
    ...
    function wp_dashboard_plugins_output ()
    {
        ...
        foreach (array('popular' => __('Most Popular'),
                       ...
                       'updated' => __('Recently Updated')) as $feed => $label) {
    ...
    function wp_dashboard_trigger_widget_control ($widget_control_id = false)
    {
        ...
        if (is_scalar($widget_control_id) && $widget_control_id && isset($wp_dashboard_control_callbacks[$widget_control_id]) && is_callable($wp_dashboard_control_callbacks[$widget_control_id])) {
            call_user_func($wp_dashboard_control_callbacks[$widget_control_id], '', array('id'       => $widget_control_id,
