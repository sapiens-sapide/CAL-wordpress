<?php
    ...
    class Walker_Category_Checklist extends Walker
    {
        ...
        var $db_fields = array('parent' => 'parent',
                               'id'     => 'term_id'); //TODO: decouple this
    ...
    function wp_popular_terms_checklist ($taxonomy, $default = 0, $number = 10, $echo = true)
    {
        ...
        $terms = get_terms($taxonomy, array('orderby'      => 'count',
                                            'order'        => 'DESC',
                                            'number'       => $number,
                                            'hierarchical' => false));
    ...
    function wp_link_category_checklist ($link_id = 0)
    {
        ...
        $categories = get_terms('link_category', array('orderby'    => 'name',
                                                       'hide_empty' => 0));
...
<div class="hidden" id="inline_' . $post->ID . '">
    ...
    function wp_comment_reply ($position = '1', $checkbox = false, $mode = 'single', $table_row = true)
    {
        ...
        $content = apply_filters('wp_comment_reply', '', array('position' => $position,
                                                               'checkbox' => $checkbox,
                                                               'mode'     => $mode));
...
<?php endif; ?>
        ...
        <div id="replycontainer">
            ...
            wp_editor('', 'replycontent', array('media_buttons' => false,
                                                'tinymce'       => false,
...
<table id="list-table" style="display: none;">
    ...
    <form id="the-attachment-links">
        <table>
            ...
            <tr>
                ...
                <td>
                    <textarea rows="1" cols="40" type="text" class="attachmentlinks" readonly="readonly"><?php echo esc_textarea(wp_get_attachment_url()); ?></textarea>
                </td>
            </tr>
            <?php if ($icon) : ?>
            <tr>
                ...
                <td>
                    <textarea rows="1" cols="40" type="text" class="attachmentlinks" readonly="readonly"><a href="<?php echo wp_get_attachment_url(); ?>"><?php echo $icon ?></a></textarea>
                </td>
            </tr>
            <tr>
                <th scope="row"><?php $thumb ? _e('Thumbnail linked to page') : _e('Image linked to page'); ?></th>
                <td>
                    <textarea rows="1" cols="40" type="text" class="attachmentlinks" readonly="readonly"><a href="<?php echo get_attachment_link($post->ID) ?>" rel="attachment wp-att-<?php echo $post->ID; ?>"><?php echo $icon ?></a></textarea>
                </td>
            </tr>
            <?php else : ?>
            <tr>
                ...
                <td>
                    <textarea rows="1" cols="40" type="text" class="attachmentlinks" readonly="readonly"><a href="<?php echo wp_get_attachment_url(); ?>" class="attachmentlink"><?php echo basename(wp_get_attachment_url()); ?></a></textarea>
                </td>
            </tr>
            <tr>
                <th scope="row"><?php _e('Link to page') ?></th>
                <td>
                    <textarea rows="1" cols="40" type="text" class="attachmentlinks" readonly="readonly"><a href="<?php echo get_attachment_link($post->ID) ?>" rel="attachment wp-att-<?php echo $post->ID ?>"><?php the_title(); ?></a></textarea>
                </td>
            </tr>
            <?php endif; ?>
        </table>
    ...
    function add_meta_box ($id, $title, $callback, $screen = null, $context = 'advanced', $priority = 'default', $callback_args = null)
    {
        ...
        $wp_meta_boxes[$page][$context][$priority][$id] = array('id'       => $id,
                                                                'title'    => $title,
                                                                'callback' => $callback,
                                                                'args'     => $callback_args);
    }
    ...
    function add_settings_section ($id, $title, $callback, $page)
    {
        ...
        $wp_settings_sections[$page][$id] = array('id'       => $id,
                                                  'title'    => $title,
                                                  'callback' => $callback);
    }
    ...
    function add_settings_field ($id, $title, $callback, $page, $section = 'default', $args = array())
    {
        ...
        $wp_settings_fields[$page][$section][$id] = array('id'       => $id,
                                                          'title'    => $title,
                                                          'callback' => $callback,
                                                          'args'     => $args);
    }
...
<meta http-equiv="Content-Type" content="<?php bloginfo('html_type'); ?>; charset=<?php echo get_option('blog_charset'); ?>"/>
    ...
    final class WP_Internal_Pointers
    {
        ...
        public static function pointer_wp330_media_uploader ()
        {
            ...
            WP_Internal_Pointers::print_js('wp330_media_uploader', '#content-add_media', array(
                'content'  => $content,
                'position' => array('edge'  => is_rtl() ? 'right' : 'left',
                                    'align' => 'center'),
            ));
        }
    ...
    function convert_to_screen ($hook_name)
    {
        if (!class_exists('WP_Screen')) {
            ...
            return (object)array('id'   => '_invalid',
