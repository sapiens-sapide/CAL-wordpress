<?php
    ...
    */
    // Reset More Fields
    if (0) {
        update_option('more_fields', array());
    }
    ...
    if (!defined('MORE_PLUGINS_DEV')) {
        include('more-plugins/more-plugins.php');
    }
    else {
        include(ABSPATH . '/wp-content/plugins/more-plugins.php');
    }
    ...
    if (is_admin()) {
        if (!defined('MORE_PLUGINS_DEV')) {
            include('more-plugins/more-plugins-admin.php');
        }
        else {
            include(ABSPATH . '/wp-content/plugins/more-plugins-admin.php');
        }
