    ...
    class Disable_Comments
    {
        ...
        <div class="wrap">
            ...
            <form action="" method="post" id="disable-comments">
                ...
                <p>
                    <strong>Note:</strong> disabling comments will also disable trackbacks and pingbacks. All comment-related fields will also be hidden from the edit/quick-edit screens of the affected posts. These settings cannot be overridden for individual posts.
                </p>

                <h3>Other options</h3>
                <ul class="indent">
                    <li>
                        <label for="remove_admin_menu_comments"><input type="checkbox" name="remove_admin_menu_comments" id="remove_admin_menu_comments" <?php checked($this->options['remove_admin_menu_comments']);?>> Remove the "Comments" link from the Admin Menu</label>
                    </li>
                    <li>
                        <label for="remove_admin_bar_comments"><input type="checkbox" name="remove_admin_bar_comments" id="remove_admin_bar_comments" <?php checked($this->options['remove_admin_bar_comments']);?>> Remove the "Comments" icon from the Admin Bar</label>
                    </li>
                    <li>
                        <label for="remove_recent_comments"><input type="checkbox" name="remove_recent_comments" id="remove_recent_comments" <?php checked($this->options['remove_recent_comments']);?>> Remove the "Recent Comments" widget from the Dashboard</label>
                    </li>
                    <li>
                        <label for="remove_discussion"><input type="checkbox" name="remove_discussion" id="remove_discussion" <?php checked($this->options['remove_discussion']);?>> Remove the "Discussion" section from the Right Now widget on the Dashboard
                            <span class="hide-if-js"><strong>(Note: this option will only work if you have Javascript enabled in your browser)</strong></span></label>
                    </li>
                </ul>
                <p>
                    <strong>Note:</strong> these options are global. They will affect all users, everywhere, regardless of whether comments are enabled on portions of your site. Use them only if you want to remove all references to comments
                    <em>everywhere</em>.
