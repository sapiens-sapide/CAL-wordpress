...
function twentyeleven_setup() {
    ...
    // custom type posts
    /*register_post_type('prestations', array(	'label' => 'Prestations','description' => '','public' => true,'show_ui' => true,'show_in_menu' => true,'capability_type' => 'post','hierarchical' => false,'rewrite' => array('slug' => ''),'query_var' => true,'supports' => array('title','editor','excerpt','trackbacks','custom-fields','comments','revisions','thumbnail','author','page-attributes',),'labels' => array (
      'name' => 'Prestations',
      'singular_name' => '',
      'menu_name' => 'Prestations',
      'add_new' => 'Add Prestations',
      'add_new_item' => 'Add New Prestations',
      'edit' => 'Edit',
      'edit_item' => 'Edit Prestations',
      'new_item' => 'New Prestations',
      'view' => 'View Prestations',
      'view_item' => 'View Prestations',
      'search_items' => 'Search Prestations',
      'not_found' => 'No Prestations Found',
      'not_found_in_trash' => 'No Prestations Found in Trash',
      'parent' => 'Parent Prestations',
    ),) );*/
}
...
/* functions added by sapienssapide */
    ...
    function register_my_menus() {
      register_nav_menus(
        array( 'leftNav-actualites' => __( 'Pages actualités' ),
