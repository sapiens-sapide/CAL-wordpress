    ...
    if (!defined($more_common)) {
        ...
        class more_plugins_admin_object_sputnik_8
        {
           ...
           */
            function more_plugins_admin_object_sputnik_8 ($settings)
            {
                ...
                if (isset($settings['settings_file'])) {
                    ...
                    $this->settings_file = $this->slug . '-settings.php';
                }
           ...
           */
            ...
            <p>
                <textarea rows="15" class="large-text readonly" name="rules" id="rules" readonly="readonly"><?php echo esc_html($export); ?></textarea>
            </p>
            <?php
                $this->options_page_wrapper_footer();
            }
           ...
           */
            ...
            function get_data ($s = array(), $override = false)
            {
                ...
                if (count($s) == 2) {
                    return $this->data[$s[0]][$s[1]];
                }
                if (count($s) == 3) {
                    return $this->data[$s[0]][$s[1]][$s[2]];
                }
                if (count($s) == 4) {
                    return $this->data[$s[0]][$s[1]][$s[2]][$s[3]];
                }
                return $this->data;
            }
            ...
            function set_data ($value, $s = array(), $override = false)
            {
                ...
                if (count($s) == 2) {
                    $this->data[$s[0]][$s[1]] = $value;
                }
                if (count($s) == 3) {
                    $this->data[$s[0]][$s[1]][$s[2]] = $value;
                }
                if (count($s) == 4) {
                    $this->data[$s[0]][$s[1]][$s[2]][$s[3]] = $value;
                }
                return $this->data;
            }
           ...
           */
            function settings_init ()
            {
                ...
                foreach ($fs as $f) if (array_key_exists($f, $_GET)) {
                    $this->{$f} = esc_attr($_GET[$f]);
                }
            ...
            function request_handler ()
            {
                ...
                if ($this->action == 'move') {
                    ...
                    if (empty($action_keys)) {
                        array_push($action_keys, '_plugin');
                    }
...
*/
                    ...
                    <div id="side-sortables" class="meta-box-sortabless ui-sortable" style="position:relative;">
                        ...
                        <div id="<?php echo $this->slug; ?>-information" class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <ul>
                                    <li>
                                        <a href="http://more-plugins.se/plugins/<?php echo $this->slug; ?>/">Plugin homepage</a>
                                    </li>
                                    <li><a href="http://more-plugins.se/forum/">Plugin support forum</a></li>
                                    <li>
                                        <a href="http://wordpress.org/tags/<?php echo $this->slug; ?>?forum_id=10">Wordpress Forum</a>
                                    </li>
                                    <li>
                                        <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&#38;business=h.melin%40gmail.com&#38;item_name=<?php echo str_replace(' ', '%20', $this->name); ?>%20Plugin&#38;no_shipping=0&#38;no_note=1&#38;tax=0&#38;currency_code=USD&#38;bn=PP%2dDonationsBF&#38;charset=UTF%2d8&#38;lc=US">Donate with PayPal</a>
                                    </li>
                                    <li>
                        ...
                        <div id="more-plugins-box" class="postbox">
                            <h3 class="hndle"><span>More Plugins</span>
                                <em><?php _e('Get More out of WordPress', 'more-plugins'); ?></em></h3>
                                ...
                                <ul class="action-links">
                                    ...
                                    <li class="more-fields">
                                        <dl>
                                            ...
                                            <?php else : ?>
                                            <dt>
                                                <a href="<?php echo $url; ?>/wp-admin/plugin-install.php?tab=plugin-information&#38;plugin=more-fields&#38;TB_iframe=true&#38;width=640&#38;height=679" class="thickbox" title="Install More Fields">More Fields</a>
                                            </dt>
                                            <?php endif; ?>
                                    ...
                                    <li class="more-types">
                                        <dl>
                                            ...
                                            <?php else : ?>
                                            <dt>
                                                <a href="<?php echo $url; ?>/wp-admin/plugin-install.php?tab=plugin-information&#38;plugin=more-types&#38;TB_iframe=true&#38;width=640&#38;height=679" class="thickbox" title="Install More Types">More Types</a>
                                            </dt>
                                            <?php endif; ?>
                                    ...
                                    <li class="more-taxonomies">
                                        <dl>
                                            ...
                                            <dt class="more-taxonomies">
                                                <a href="options-general.php?page=more-taxonomies">More Taxonomies</a>
                                            </dt>
                                            <?php else : ?>
                                            <dt class="more-taxonomies">
                                                <a href="<?php echo $url; ?>/wp-admin/plugin-install.php?tab=plugin-information&#38;plugin=more-taxonomies&#38;TB_iframe=true&#38;width=640&#38;height=679" class="thickbox" title="Install More Taxonomies">More Taxonomies</a>
                                            </dt>
                                            <?php endif; ?>
           ...
           */
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <label><input type="checkbox" name="<?php echo $name; ?>[]" value="<?php echo $key; ?>" <?php echo $checked; ?>> <?php echo $title2; ?>
                    </label>
                    <?php endforeach; ?>
                </td>
            </tr>
           ...
           */
            function updown_link ($nbr, $total, $args = array())
            {
                ...
                // Build the links
                if ($nbr > 0) {
                    $html .= ' | ' . $this->settings_link('&uarr;', array_merge($link, array('direction' => 'up')));
                }
                if ($nbr < $total - 1) {
                    $html .= ' | ' . $this->settings_link('&darr;', array_merge($link, array('direction' => 'down')));
                }
                return $html;
            }
           ...
           */
            function nonce_action ($args = array())
            {
                ...
                if (array_key_exists('navigation', $args)) {
                    if ($a = esc_attr($args['navigation'])) {
                        $action .= $a;
                    }
                }
                if (array_key_exists('action', $args)) {
                    if ($a = esc_attr($args['action'])) {
                        $action .= $a;
                    }
                }
           ...
           */
            ...
            function slasherize ($var, $strip = false)
            {
                ...
                foreach ($var as $k => $v) {
                    if (!$strip) {
                        $ret[$k] = (is_array($v)) ? $this->slasherize($v) : str_replace(array('"', "'"), array($word, strrev($word)), stripslashes_deep(htmlspecialchars_decode($v)));
                    }
                    else {
                        $ret[$k] = (is_array($v)) ? $this->slasherize($v, true) : str_replace(array($word, strrev($word)), array('"', "'"), $v);
                    }
                }
                return $ret;
            }
           ...
           */
            ...
            <?php
                if (!defined('MORE_PLUGINS_DEV')) {
                    ...
                    $css = WP_PLUGIN_URL . '/more-plugins.css';
                }
                ?>
