...
<h1 id="logo"><img alt="WordPress" src="images/wordpress-logo.png"/></h1>
    ...
    switch ($step) {
        case 0:
            ...
            <p>
                <strong>Si pour une raison quelconque la cr&eacute;ation automatique du fichier ne fonctionnait pas, ne paniquez pas : elle ne fait que remplir les informations de la base de donn&eacute;es dans un fichier de configuration. Vous pouvez donc simplement ouvrir
                    <code>wp-config-sample.php</code> dans un &eacute;diteur de texte, y entrer vos informations, et enregistrer le fichier sous le nouveau nom
                    <code>wp-config.php</code>.</strong></p>
            ...
            <p class="step">
                <a href="setup-config.php?step=1<?php if (isset($_GET['noapi'])) {
                    echo '&amp;noapi';
                } ?>" class="button">Allons-y !</a>
            </p>
                <?php
            break;
            ...
            <form method="post" action="setup-config.php?step=2">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>Si
                            <code>localhost</code> ne marche pas, vous devrez demander cette information à votre hébergeur.
                        </td>
                    </tr>
                    <tr>
        ...
        case 2:
            ...
            if (preg_match('|[^a-z0-9_]|i', $prefix))
                wp_die( /*WP_I18N_BAD_PREFIX*/
                    '<strong>ERREUR</strong>: "Préfixe de table" ne peut contenir que des chiffres, lettres, et caractère souligné ("underscore").' /*/WP_I18N_BAD_PREFIX*/);
            ...
            <p>Vous pouvez créer un fichier
                <code>wp-config.php</code> manuellement, et y copier/coller le texte suivant.</p>
