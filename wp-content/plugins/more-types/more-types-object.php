        ...
        function init_post_types ()
        {
            ...
            foreach ((array)$pages as $name => $page) {
                ...
                */
                ...
                if (!$options['name']) {
                    $options['name'] = $page['labels']['name'];
                }
                if (!$options['label']) {
                    $options['label'] = $page['labels']['name'];
                }
                if (!$options['singular_label']) {
                    $options['singular_label'] = $page['labels']['singular_name'];
                }
                ...
                if (!array_key_exists('menu_name', $options['labels'])) {
                    $options['labels']['menu_name'] = $page['labels']['name'];
                }
                else {
                    if (!$options['labels']['menu_name']) {
                        $options['labels']['menu_name'] = $page['labels']['name'];
                    }
                }
                ...
                if ($page['rewrite_bool'] && ($rw = $page['rewrite_slug'])) {
                    $options['rewrite'] = array('slug' => $rw);
                }
                else {
                ...
                if (!array_key_exists('menu_position', $options)) {
                    $options['menu_position'] = null;
                }

                // Remove if nowt is set
                if (!$options['menu_icon']) {
                ...
                if ($mp = $options['menu_position']) {
                    $options['menu_position'] = intval($mp);
                }
